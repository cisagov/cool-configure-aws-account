...
issue](https://github.com/cisagov/cool-configure-aws-account/issues) in this
...
request](https://github.com/cisagov/cool-configure-aws-account/pulls), you
...
```console
cd cool-configure-aws-account
pyenv virtualenv <python_version_to_use> cool-configure-aws-account
pyenv local cool-configure-aws-account
