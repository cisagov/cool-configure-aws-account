...
| master\_account\_workspace | The name of the Terraform workspace where the master account remote state is stored (e.g. "production").  This corresponds to the name of the environment where the master account was provisioned. | `string` | n/a | yes |
